...
let newName = prompt("Ingrese el nombre deseado");

//Mostrar en un alert: "Si se encuentra" o "No se encuentra"

alert(`${students.find(element => element == newName) ? "Si" : "No"} se encuentra `+ newName);*/
...
let books = prompt("Ingrese el libro deseado");
alert(`${programmingBooks.find(element => element == books) ? "Si" : "No"} se encuentra el libro ` + books);*/
